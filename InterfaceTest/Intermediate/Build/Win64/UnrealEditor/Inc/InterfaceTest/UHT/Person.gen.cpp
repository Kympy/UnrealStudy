...
// End Cross Module References
	...
	template<> INTERFACETEST_API UClass* StaticClass<UPerson>()
	{
		return UPerson::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UPerson);
	UPerson::~UPerson() {}
	struct Z_CompiledInDeferFile_FID_TestUnreal_UnrealStudy_InterfaceTest_Source_InterfaceTest_Person_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_TestUnreal_UnrealStudy_InterfaceTest_Source_InterfaceTest_Person_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPerson, UPerson::StaticClass, TEXT("UPerson"), &Z_Registration_Info_UClass_UPerson, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPerson), 3327216689U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_TestUnreal_UnrealStudy_InterfaceTest_Source_InterfaceTest_Person_h_1518428984(TEXT("/Script/InterfaceTest"),
		Z_CompiledInDeferFile_FID_TestUnreal_UnrealStudy_InterfaceTest_Source_InterfaceTest_Person_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_TestUnreal_UnrealStudy_InterfaceTest_Source_InterfaceTest_Person_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
