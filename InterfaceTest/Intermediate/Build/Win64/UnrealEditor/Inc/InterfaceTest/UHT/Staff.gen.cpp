...
#include "InterfaceTest/Staff.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeStaff() {}
// Cross Module References
	INTERFACETEST_API UClass* Z_Construct_UClass_UPerson();
	INTERFACETEST_API UClass* Z_Construct_UClass_UStaff();
	INTERFACETEST_API UClass* Z_Construct_UClass_UStaff_NoRegister();
...
// End Cross Module References
	...
	template<> INTERFACETEST_API UClass* StaticClass<UStaff>()
	{
		return UStaff::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UStaff);
	UStaff::~UStaff() {}
	struct Z_CompiledInDeferFile_FID_TestUnreal_UnrealStudy_InterfaceTest_Source_InterfaceTest_Staff_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_TestUnreal_UnrealStudy_InterfaceTest_Source_InterfaceTest_Staff_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UStaff, UStaff::StaticClass, TEXT("UStaff"), &Z_Registration_Info_UClass_UStaff, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UStaff), 1733127422U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_TestUnreal_UnrealStudy_InterfaceTest_Source_InterfaceTest_Staff_h_2793261944(TEXT("/Script/InterfaceTest"),
		Z_CompiledInDeferFile_FID_TestUnreal_UnrealStudy_InterfaceTest_Source_InterfaceTest_Staff_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_TestUnreal_UnrealStudy_InterfaceTest_Source_InterfaceTest_Staff_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
